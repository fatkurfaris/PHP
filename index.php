  ...
  <div class="row samping">
    <div class="col-6 col-md-4 ">
        ...
        <img src="img/Sport_4.png" class="card-img-top" alt="...">
          <div class="card-body">
            <a href="photography_sport.php" title=""><h4 class="tulis" align="center"><b>SPORT</b></h4></a>
        </div>
    </div>
    </div>
    <div class="col-6 col-md-4 ">
        ...
        <img src="img/Food_2.png" class="card-img-top" alt="...">
          <div class="card-body">
            <a href="photography_food.php" title=""><h4 class="tulis" align="center"><b>FOOD</b></h4></a>
        </div>
    </div>
    </div>
    <div class="col-6 col-md-4 bawah2 ">
        ...
        <img src="img/Photo_6.png" class="card-img-top" alt="...">
          <div class="card-body ">
            <a href="photography_photo.php" title=""><h4 class="tulis" align="center"><b>Photo</b></h4></a>
        </div >
    </div>
    </div>
  </div>
