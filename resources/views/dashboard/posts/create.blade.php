...
<div class="col-lg-8">
    ...
    <form method="post" action="/dashboard/posts">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('excerpt') is-invalid @enderror" id="excerpt" name="excerpt" required value="{{ old('excerpt') }}">
          @error('excerpt')
          <div class="invalid-feedback">
              {{ $message }}
            @enderror
        ...
        <div class="mb-3">
          ...
          <textarea type="text"  rows="3" class="form-control @error('body') is-invalid @enderror" id="body" name="body"  value="{{ old('body') }}"></textarea>
          @error('body')
            <div class="invalid-feedback">
                {{ $message }}
          @enderror
